...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/tahun-ajaran/' . encrypt($tahunAjaran->id))); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <input type="number" maxlength="4" oninput="this.value=this.value.slice(0,this.maxLength)" class="form-control <?php $__errorArgs = ['start_year'];
...
unset($__errorArgs, $__bag); ?>" name="start_year" id="start_year" placeholder="tahun awal" value="<?php echo e(old('start_year') ? old('start_year') : $tahunAjaran->start_year); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-5">
                                            <input type="number" maxlength="4" oninput="this.value=this.value.slice(0,this.maxLength)" class="form-control <?php $__errorArgs = ['end_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="end_year" id="end_year" placeholder="tahun akhir" value="<?php echo e(old('end_year') ? old('end_year') : $tahunAjaran->end_year); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(url('/app-admin/tahun-ajaran')); ?>" class="btn btn-dark">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/tahun-ajaran/edit.blade.php ENDPATH**/ ?>