...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('app-admin/mahasiswa/' . $mahasiswa->nim . '/bayar/' . encrypt($iuran->id) . '/' . $semester . '/' . $pembayaran->id_pembayaran)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            <label for="semester_iuran" class="font-weight-bold">iuran Semester <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="id_iuran" class="font-weight-bold">Kekurangan<span class="text-danger">*</span></label>
                                    <input type="text" placeholder="kekurangan" class="form-control" autocomplete="off" readonly="" value="Rp <?php echo e(number_format($kekurangan, 0, '.', '.')); ?>">
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/mahasiswa/edit-iuran.blade.php ENDPATH**/ ?>