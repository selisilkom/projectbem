...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/petugas/' . encrypt($petugas->id_petugas))); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nama_petugas') ? old('nama_petugas') : $petugas->nama_petugas); ?>"
                                ...
                                <select class="form-control" name="level" required="">
                                    <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($level); ?>"
                                            <?php if(old('level')): ?> <?php echo e(old('level') == $level ? 'selected' : ''); ?>

                                    <?php else: ?>
                                        <?php echo e($petugas->level == $level ? 'selected' : ''); ?> <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('username') ? old('username') : $petugas->username); ?>" placeholder="username"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/petugas/edit.blade.php ENDPATH**/ ?>