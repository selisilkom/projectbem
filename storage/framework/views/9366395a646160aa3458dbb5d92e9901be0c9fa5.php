...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/iuran/' . encrypt($iuran->id))); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nominal') ? old('nominal') : 'Rp. ' . number_format($iuran->nominal, 0, '.', '.')); ?>" placeholder="nominal iuran" autocomplete="off" id="nominal">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/iuran/edit.blade.php ENDPATH**/ ?>