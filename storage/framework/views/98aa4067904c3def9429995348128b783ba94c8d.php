...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/organisasi/' . encrypt($organisasi->id_organisasi))); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nama_organisasi') ? old('nama_organisasi') : $organisasi->nama_organisasi); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bemv2\resources\views/admin/pages/organisasi/edit.blade.php ENDPATH**/ ?>