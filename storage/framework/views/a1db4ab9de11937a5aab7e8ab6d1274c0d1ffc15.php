...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/iuran')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('tahun_pertama')); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('tahun_kedua')); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nominal')); ?>" placeholder="nominal iuran" autocomplete="off" id="nominal">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(url('/app-admin/iuran')); ?>" class="btn btn-dark">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/iuran/create.blade.php ENDPATH**/ ?>