...
<?php endif; ?>
                    <?php endif; ?>
                    <form action="<?php echo e(url('/app-admin/mahasiswa')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nim')); ?>" placeholder="nim" autocomplete="off" id="nim" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nama')); ?>" placeholder="nama mahasiswa" autocomplete="off" id="nama"
                                required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('email')); ?>" placeholder="email" autocomplete="off" id="email" required>
                            ...
                            <select class="form-control" name="jenis_kelamin" required="">
                                ...
                                <?php $__currentLoopData = $jenis_kelamins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_kelamin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($jenis_kelamin); ?>"
                                        <?php if(old('jenis_kelamin')): ?> <?php echo e(old('jenis_kelamin') == $jenis_kelamin ? 'selected' : ''); ?> <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('no_telp')); ?>" placeholder="no telp" autocomplete="off" id="no_telp"
                                required>
...
unset($__errorArgs, $__bag); ?>" style="height: 100px"
                                placeholder="alamat" required><?php echo e(old('alamat')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomy/htdocs/matursoft/clients/mhmmdd-bem-pembayaran/resources/views/admin/pages/mahasiswa/create.blade.php ENDPATH**/ ?>