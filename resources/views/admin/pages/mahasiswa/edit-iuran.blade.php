        ...
        <div class="col-lg-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('app-admin/mahasiswa/' . $mahasiswa->nim . '/bayar/' . encrypt($iuran->id) . '/' . $semester . '/' . $pembayaran->id_pembayaran) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="kekurangan" class="form-control" autocomplete="off" readonly="" value="Rp {{ number_format($kekurangan, 0, '.', '.') }}">
                                </div>
