        ...
        <div class="col-lg-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/app-admin/mahasiswa/' . encrypt($mahasiswa->nim)) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nim" class="form-control @error('nim') is-invalid @enderror"
                                value="{{ old('nim') ? old('nim') : $mahasiswa->nim }}" placeholder="nim" autocomplete="off"
                                id="nim">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                value="{{ old('nama') ? old('nama') : $mahasiswa->nama }}" placeholder="nama mahasiswa"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control @error('email') is-invalid @enderror"
                                value="{{ old('email') ? old('email') : $mahasiswa->email }}" placeholder="email mahasiswa"
                            ...
                            <select class="form-control" name="jenis_kelamin" required="">
                                ...
                                @foreach ($jenis_kelamins as $jenis_kelamin)
                                    <option value="{{ $jenis_kelamin }}"
                                        @if (old('jenis_kelamin')) {{ strtolower(old('jenis_kelamin')) == strtolower($jenis_kelamin) ? 'selected' : '' }}
                                        @else
                                            {{ strtolower($jenis_kelamin) == strtolower($mahasiswa->jenis_kelamin) ? 'selected' : '' }} @endif>
                                        {{ $jenis_kelamin }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror"
                                value="{{ old('no_telp') ? old('no_telp') : $mahasiswa->no_telp }}" placeholder="no telp"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" style="height: 100px"
                                placeholder="alamat">{{ old('alamat') ? old('alamat') : $mahasiswa->alamat }}</textarea>
