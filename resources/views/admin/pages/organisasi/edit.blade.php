        ...
        <div class="col-lg-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/app-admin/organisasi/' . encrypt($organisasi->id_organisasi)) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_organisasi"
                                ...
                                value="{{ old('nama_organisasi') ? old('nama_organisasi') : $organisasi->nama_organisasi }}"
